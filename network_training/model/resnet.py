...
def resnet34(pretrained=False,num_classes=1, progress=True, **kwargs):
...
#modified by Enze
def resnet101(pretrained=False, progress=True, num_classes=1, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], num_classes, pretrained, progress,
                   **kwargs)
