...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        with open(file_name, 'a') as log:
            ...
            log.writelines(out_message + '\n')
            out_message='the previous best is %.3f'%(self.best_pred)
            log.writelines(out_message + '\n')
        ...
        if new_pred < self.best_pred:
            print('val loss is %.3f and lower then previous best %.3f, save model' % (new_pred,self.best_pred))
            is_best = True
