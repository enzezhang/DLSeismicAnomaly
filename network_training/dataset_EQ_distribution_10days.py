...
def make_dataset(root,list_txt,train=True):
    ...
    if train:
        for line in files_list:
            ...
            sig_name8 = names_list[7]
            sig_name9 = names_list[8]
            sig_name10 = names_list[9]

            label_name1_2 = names_list[10]
            label_name2_3 = names_list[11]
            label_name3_4 = names_list[12]
            label_name4_5 = names_list[13]
            label_name5_6 = names_list[14]
            label_name6_7 = names_list[15]
            label_name7_8 = names_list[16]
            label_name8_9 = names_list[17]
            label_name9_10 = names_list[18].strip()


            dataset.append([sig_name1, sig_name2,sig_name3,sig_name4,sig_name5,sig_name6,sig_name7,sig_name8,sig_name9,sig_name10,label_name1_2,label_name2_3,label_name3_4,label_name4_5,label_name5_6,label_name6_7,label_name7_8,label_name8_9,label_name9_10])
        ...
        for line in files_list:
            ...
            sig_name8 = names_list[7]
            sig_name9 = names_list[8]
            sig_name10 = names_list[9].strip()
            dataset.append([sig_name1, sig_name2, sig_name3, sig_name4, sig_name5,sig_name6,sig_name7,sig_name8,sig_name9,sig_name10])
...
class distribution_maps(data.Dataset):
    ...
    def __getitem__(self, idx):
        if self.train:
            sig_data1, sig_data2,sig_data3, sig_data4, sig_data5,sig_data6,sig_data7,sig_data8,sig_data9,sig_data10, gt_patch1_2,gt_patch2_3,gt_patch3_4,gt_patch4_5,gt_patch5_6,gt_patch6_7,gt_patch7_8,gt_patch8_9,gt_patch9_10 = self.data[idx]
           # print(idx)
            ...
            sig8 = read_patch(sig_data8, self.nCol)
            sig9 = read_patch(sig_data9, self.nCol)
            sig10 = read_patch(sig_data10, self.nCol)
            ...
            gt7_8 = int(gt_patch7_8)
            gt8_9 = int(gt_patch8_9)
            gt9_10 = int(gt_patch9_10)
            sig=np.stack((sig1,sig2,sig3,sig4,sig5,sig6,sig7,sig8,sig9,sig10))
            sig = np.atleast_2d(sig).astype(np.float32)
            sig = torch.from_numpy(sig).float()
            gt = np.stack((gt1_2, gt2_3, gt3_4, gt4_5,gt5_6,gt6_7,gt7_8,gt8_9,gt9_10))
            gt = np.atleast_1d(gt)
            gt = torch.from_numpy(gt).float()

            return sig, gt
        else:
            sig_data1, sig_data2, sig_data3, sig_data4, sig_data5,sig_data6,sig_data7,sig_data8,sig_data9,sig_data10 = self.data[idx]
            sig1 = read_patch(sig_data1, self.nCol)
            sig2 = read_patch(sig_data2, self.nCol)
            sig3 = read_patch(sig_data3, self.nCol)
            sig4 = read_patch(sig_data4, self.nCol)
