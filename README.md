...
pip install tensorboardX tqdm torch torchvision pyproj scipy imgaug==0.2.5 rasterio opencv-python==3.4.0.12

## Step 0: change dir

change working_root,data_changning, and data_weiyuan in file network_training/para.ini
